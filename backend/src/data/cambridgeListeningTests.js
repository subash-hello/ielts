    ...
    "parts": [
      {
        ...
        "displayLayouts": [
          {
            "type": "table",
            "questionIds": ["c10q6", "c10q7", "c10q8", "c10q9", "c10q10"],
            "headers": ["Location", "Job title", "Responsibilities Include", "Pay and conditions"],
            "rows": [
              ["{{c10q6}} Street", "Breakfast supervisor", "Checking portions, etc. are correct<br/>Making sure {{c10q7}} is clean", "Starting salary £{{c10q8}} per hour<br/>Start work at 5.30 a.m."],
              ["City Road", "Junior chef", "Supporting senior chefs<br/>Maintaining stock and organising {{c10q9}}", "Annual salary £23,000<br/>No work on a {{c10q10}} once a month"]
            ]
          }
        ],
        "questions": [
